...
local chat = msg.chat_id_
user_id = msg.sender_user_id_
o = database:get("JOKER:spam:lock:"..os.date("%x")..bot_id..msg.chat_id_)
...
database:incr("JOKER:spam:lock:"..os.date("%x")..bot_id..msg.chat_id_)
...
database:set("JOKER:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,JOKER_edis[1])
elseif (database:get("JOKER:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id)) then 
send(msg.chat_id_, msg.id_, 1, "✔┇ تم الحفظ بنجاح", 1, 'md')
database:set("JOKER:edit:text:su:new:"..bot_id..msg.chat_id_..database:get("JOKER:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("JOKER:edit:text:su:new2:"..bot_id..msg.chat_id_..text,database:get("JOKER:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id))
database:del("JOKER:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id)
end  
...
database:set("JOKER:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_,'JOKER')
return "JOKER"
end
if text and is_owner(msg) and database:get("JOKER:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("JOKER:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_)
...
y = database:get("JOKER:fel:o:me:"..bot_id..msg.chat_id_) or 10
x = database:get("JOKER:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_) or 0
send(msg.chat_id_, msg.reply_to_message_id_, 1, "⚠┇تم الابلاغ على الرساله\n⚠┇تبقى {"..(y-(x+1)).."} حتى يتم حذف الرساله", 1, 'html')
database:incr("JOKER:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)
if (database:get("JOKER:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)) then 
x = database:get("JOKER:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)
y = database:get("JOKER:fel:o:me:"..bot_id..msg.chat_id_) or 10
...
database:set("JOKER:fel:o:me:"..bot_id..msg.chat_id_,a[2])
...
if text:match("^(عدد السحكات)$") or text:match("^(تعديلاتي)$") then
...
database:set("JOKER:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok")
return "JOKER"
end  
if (text and database:get("JOKER:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
send(msg.chat_id_, msg.id_, 1, '✔┇تم حذف صلاحيه بنجاح', 1, 'md')
database:del("JOKER:all_if:"..text..bot_id..msg.chat_id_)
database:del("JOKER:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end
