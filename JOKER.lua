...
info = '📮  ¦ المستخدم ⊰• ['..result.first_name_..'](t.me/'..(result.username_ or 'JOKERteam')..')\n'..text
...
if is_sudo(msg) then
t = database:get("JOKER:name_sudo"..bot_id..msg.chat_id_)  or 'مطور البوت 👨🏻‍✈️'
elseif is_creatorbasic(msg) then
t = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍✈️'
...
t = database:get("JOKER:name_adm"..bot_id..msg.chat_id_) or ' ادمن الكروب خالي 👩🏿‍🚒'
elseif is_vip(msg) then
t = database:get("JOKER:name_vipp"..bot_id..msg.chat_id_) or 'عضو مميز  🧟‍♂'
else
t = database:get("JOKER:name_nk"..bot_id..msg.chat_id_) or 'عضو محد يحترمك 👶🏻😹' 
end
...
local tahna = (database:get('JOKER:'..bot_id..'nummsg'..msg.chat_id_..result.sender_user_id_) or 0)
if tonumber((database:get('JOKER:'..bot_id..'add:numall'..msg.chat_id_..result.sender_user_id_) or 0)) == 0 then
nko = '0'
else
nko = (database:get('JOKER:'..bot_id..'add:numall'..msg.chat_id_..result.sender_user_id_))
end
local msgs = ((database:get('JOKER:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_) or 0) + tahna)
...
JOKER_oop = database:get("JOKER:name_sudo"..bot_id..msg.chat_id_)  or 'مطور البوت'
elseif is_creatorbasic(msg) then
JOKER_oop = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي'
...
elseif is_creator(msg) then
JOKER_oop = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب'
...
JOKER_oop = database:get("JOKER:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب'
elseif is_mod(msg2) then
JOKER_oop = database:get("JOKER:name_adm"..bot_id..msg.chat_id_) or 'ادمن للكروب'
elseif is_vip(msg2) then
JOKER_oop = database:get("JOKER:name_vipp"..bot_id..msg.chat_id_) or 'عضو مميز'
else
JOKER_oop = database:get("JOKER:name_nk"..bot_id..msg.chat_id_) or 'عضو فقط' 
end
...
if result.id_ then
if not database:get('JOKER:'..bot_id..'id:mute'..msg.chat_id_) then 
local tahna = (database:get('JOKER:'..bot_id..'nummsg'..msg.chat_id_..result.id_) or 0)
if tonumber((database:get('JOKER:'..bot_id..'add:numall'..msg.chat_id_..result.id_) or 0)) == 0 then
nko = '0'
else
nko = (database:get('JOKER:'..bot_id..'add:numall'..msg.chat_id_..result.id_))
end
local msgs = ((database:get('JOKER:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0) + tahna)
local edit = database:get('JOKER:'..bot_id..'user:editmsg'..msg.chat_id_..':'..result.id_) or 0
local msg2 = msg
msg2.sender_user_id_ = result.id_
local user_msgs = ((database:get('JOKER:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0) + tahna)
local ikeko_text = "غير متفاعل"
if user_msgs then 
if tonumber(user_msgs) < 50 then 
ikeko_text = "غير متفاعل"
...
local function keko_JOKER(data)
    JSON = (loadfile  "./libs/dkjson.lua")()
...
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
end
if msg.content_.caption_ then
text = msg.content_.caption_
...
if database:get("lock_chat.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.forward_info_ then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
if database:get("lock_fwd.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageSticker" then
if database:get("lock_stecker.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageUnsupported" then
if database:get("lock_note.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessagePhoto" then
if database:get("lock_photo.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageAudio" then
if database:get("lock_audeo.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageVoice" then
if database:get("lock_voice.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageVideo" then
if database:get("lock_video.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageAnimation" then
if database:get("lock_gif.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageContact" then
if database:get("lock_contect.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.ID == "MessageDocument" then
if database:get("lock_files.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if msg.content_.entities_[0] then
if msg.content_.entities_[0] and msg.content_.entities_[0].ID == "MessageEntityUrl" or msg.content_.entities_[0].ID == "MessageEntityTextUrl" then
if database:get("lock_mark.note:JOKER"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
 ...
 if text then 
  ...
  local hash =   'JOKER:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "👥┇قائمة المقيدين ،\n ٴ━━━━━━━━━━ \n"
    for k,v in pairs(list) do
    local user_info = database:hgetall('JOKER'..bot_id.."user:"..v)
  ...
  local hash =   'JOKER:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash) 
    for k,v in pairs(list) do database:del('JOKER:'..bot_id..'res:'..msg.chat_id_) 
...
if value == "lock" then
function keko333(extra,result,success)
info = '💬┇المستخدم ← ['..result.first_name_..'](t.me/'..(result.username_ or 'llJOKERll')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
 end
getUser(msg.sender_user_id_, keko333)
end
...
local id_JOKERx = JOKERx2.sender_user_id_
function keko333(extra,result,success)
info = '👤┇العضو ← ['..result.first_name_..'](t.me/'..(result.username_ or 'llJOKERll')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
 end
getUser(id_JOKERx, keko333)
end
...
if value ~= "prore" and value~= "lock"  then
function keko333(extra,result,success)
info = '👤┇العضو ← ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'llJOKERll')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(value, keko333)
end
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
  ...
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, result.id_)
  texts = '👤┇العضو ← ['..result.title_..'](t.me/'..(res[2] or 'llJOKERll')..')\n📡┇تم تقييده'
  end
  else
  texts = '✖️┇خطاء'
  end
  ...
  database:sadd('JOKER:'..bot_id..'res:'..msg.chat_id_, res[2])
  tsX000(res[2],msg,"📡┇تم تقييده")
  end
  end
...
if (text == "قفل التاك بالتقيد") then
  local tsX_o = database:get("lock_tag.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل التاك بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل التاك بالتقييد")
  database:set("lock_tag.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الشارحه بالتقيد") then
  local tsX_o = database:get("lock_sarha.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الشارحه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الشارحه بالتقييد")
  database:set("lock_sarha.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل المتحركه بالتقيد") then
  local tsX_o = database:get("lock_gif.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل المتحركه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل المتحركه بالتقييد")
  database:set("lock_gif.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الملفات بالتقيد") then
  local tsX_o = database:get("lock_files.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الملفات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الملفات بالتقييد")
  database:set("lock_files.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الماركدون بالتقيد") then
  local tsX_o = database:get("lock_mark.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الماكدون بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الماركدون بالتقييد")
  database:set("lock_mark.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الصور بالتقيد") then
  local tsX_o = database:get("lock_photo.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الصور بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الصور بالتقييد")
  database:set("lock_photo.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الملصقات بالتقيد") then
  local tsX_o = database:get("lock_stecker.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الملصقات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الملصقات بالتقييد")
  database:set("lock_stecker.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الفيديو بالتقيد") then
  local tsX_o = database:get("lock_video.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الفيديو بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الفيديو بالتقييد")
  database:set("lock_video.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الانلاين بالتقيد") then
  local tsX_o = database:get("lock_inline.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الانلاين بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الانلاين بالتقييد")
  database:set("lock_inline.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الدردشه بالتقيد") then
  local tsX_o = database:get("lock_chat.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الدردشه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الدردشه بالتقييد")
  database:set("lock_chat.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل التوجيه بالتقيد") then
  local tsX_o = database:get("lock_fwd.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل التوجيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل التوجيه بالتقييد")
  database:set("lock_fwd.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الاغاني بالتقيد") then
  local tsX_o = database:get("lock_audeo.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الاغاني بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الاغاني بالتقييد")
  database:set("lock_audeo.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الصوت بالتقيد") then
  local tsX_o = database:get("lock_voice.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الصوت بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الصوت بالتقييد")
  database:set("lock_voice.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الجهات بالتقيد") then
  local tsX_o = database:get("lock_contact.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الجهات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الجهات بالتقييد")
  database:set("lock_contact.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل العربيه بالتقيد") then
  local tsX_o = database:get("lock_ar.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
    tsX000("lock",msg,"📡┇بالفعل تم قفل العربيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل العربيه بالتقييد")
  database:set("lock_ar.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الانكليزيه بالتقيد") then
  local tsX_o = database:get("lock_en.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل الانكليزيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الانكليزيه بالتقييد")
  database:set("lock_en.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الروابط بالتقيد") then
  local tsX_o = database:get("lock_link.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
    tsX000("lock",msg,"📡┇بالفعل تم قفل الروابط بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل الروابط بالتقييد")
  database:set("lock_link.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل المعرف بالتقيد") then
  local tsX_o = database:get("lock_username.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
   tsX000("lock",msg,"📡┇بالفعل تم قفل المعرف بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل المعرف بالتقييد")
  database:set("lock_username.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل بصمه الفيديو بالتقيد") then
  local tsX_o = database:get("lock_note.note:JOKER"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم قفل بصمه الفيديو بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم قفل بصمه الفيديو بالتقييد")
  database:set("lock_note.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
end
if is_mod(msg) then
  ...
  local tsX_o = database:get("lock_tag.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح التاك بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح التاك بالتقييد")
  database:del("lock_tag.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الشارحه بالتقيد") then
  local tsX_o = database:get("lock_sarha.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الشارحه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الشارحه بالتقييد")
  database:del("lock_sarha.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح المتحركه بالتقيد") then
  local tsX_o = database:get("lock_gif.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"📡┇بالفعل تم فتح المتحركه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح المتحركه بالتقييد")
  database:del("lock_gif.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الملفات بالتقيد") then
  local tsX_o = database:get("lock_files.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الملفات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الملفات بالتقييد")
  database:del("lock_files.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الماركدون بالتقيد") then
  local tsX_o = database:get("lock_mark.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الماركدون بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الماركدون بالتقييد")
  database:del("lock_mark.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الصور بالتقيد") then
  local tsX_o = database:get("lock_photo.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الصور بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الصور بالتقييد")
  database:del("lock_photo.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الملصقات بالتقيد") then
  local tsX_o = database:get("lock_stecker.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الملصقات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الملصقات بالتقييد")
  database:del("lock_stecker.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الفيديو بالتقيد") then
  local tsX_o = database:get("lock_video.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الفيديو بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الفيديو بالتقييد")
  database:del("lock_video.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الانلاين بالتقيد") then
  local tsX_o = database:get("lock_inline.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الانلاين بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الانلاين بالتقييد")
  database:del("lock_inline.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الدردشه بالتقيد") then
  local tsX_o = database:get("lock_chat.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الدردشه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الدردشه بالتقييد")
  database:del("lock_chat.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح التوجيه بالتقيد") then
  local tsX_o = database:get("lock_fwd.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح التوجيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح التوجيه بالتقييد")
  database:del("lock_fwd.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الاغاني بالتقيد") then
  local tsX_o = database:get("lock_audeo.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الاغاني بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الاغاني بالتقييد")
  database:del("lock_audeo.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الصوت بالتقيد") then
  local tsX_o = database:get("lock_voice.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الصوت بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الصوت بالتقييد")
  database:del("lock_voice.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الجهات بالتقيد") then
  local tsX_o = database:get("lock_contact.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الجهات بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الجهات بالتقييد")
  database:del("lock_contact.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح العربيه بالتقيد") then
  local tsX_o = database:get("lock_ar.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح العربيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح العربيه بالتقييد")
  database:del("lock_ar.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الانكليزيه بالتقيد") then
  local tsX_o = database:get("lock_en.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الانكليزيه بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الانكليزيه بالتقييد")
  database:del("lock_en.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح المعرف بالتقيد") then
  local tsX_o = database:get("lock_username.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح المعرف بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح المعرف بالتقييد")
  database:del("lock_username.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح بصمه الفيديو بالتقيد") then
  local tsX_o = database:get("lock_note.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح بصمه الفيديو بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح بصمه الفيديو بالتقييد")
  database:del("lock_note.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "فتح الروابط بالتقيد") then
  local tsX_o = database:get("lock_link.note:JOKER"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"📡┇بالفعل تم فتح الروابط بالتقييد")
  else
  tsX000("lock",msg,"📡┇تم فتح الروابط بالتقييد")
  database:del("lock_link.note:JOKER"..msg.chat_id_..bot_id,"ok")
  end
  end
  end
       ...
       ------------
       if database:get("lock_inline.note:JOKER"..msg.chat_id_..bot_id) then
       mute_in = '✔┇'
       else
       mute_in = '✖┇'
       end
  ...
  if database:get("lock_sarha.note:JOKER"..msg.chat_id_..bot_id) then
   ...
   if database:get("lock_username.note:JOKER"..msg.chat_id_..bot_id) then
       ...
       ------------
  if database:get("lock_contact.note:JOKER"..msg.chat_id_..bot_id) then
       lock_contact = '✔┇'
       else
       lock_contact = '✖┇'
       end
...
local ex = database:ttl( 'JOKER:'..bot_id.."charge:"..msg.chat_id_)
  ...
  redis:set('JOKER:'..bot_id..'hres1'..msg.sender_user_id_..'', 'msg')
    return false end
  local keko2 = redis:get('JOKER:'..bot_id..'hres1'..msg.sender_user_id_..'')
  if keko2 == 'msg' then
  if text:match("^(.*)$") then
  send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
  redis:set('JOKER:'..bot_id..'hres1'..msg.sender_user_id_..'', 'no')
  redis:set('JOKER:'..bot_id..'hres', text)
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    return false end
   end
     if text == "اوامر التقيد" or text == "5م" and is_mod(msg) then
  local hres = redis:get('JOKER:'..bot_id..'hres')
     local text =  [[
👨‍🏫 ⊰• آوآمر حماية المجموعه بالتقيد
  ¦ ـ➖➖➖➖➖➖➖
  🅰 ¦ قفل ← فتح = بالتقيد
  🅱 ¦ تقيد ← الغاء التقيد
   ٴ━━━━━━━━━━
...
redis:del('JOKER:'..bot_id..'name_bot')
...
redis:set('JOKER:'..bot_id..'textst'..msg.sender_user_id_..'', 'msg')
return false 
else
...
if text:match("^(.*)$") then
local keko2 = redis:get('JOKER:'..bot_id..'textst'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️¦  تم حفظ الاسم ✓', 1, 'html')
redis:set('JOKER:'..bot_id..'textst'..msg.sender_user_id_..'', 'no')
redis:set('JOKER:'..bot_id..'name_bot', text)
return false end
end
...
--------------------------------
if (text and text == redis:get('JOKER:'..bot_id..'name_bot'))then
name_bot = redis:get('JOKER:'..bot_id..'name_bot')
local namebot = {
...
database:del('JOKER:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)  
database:del('JOKER:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_)  
send(msg.chat_id_, msg.id_, 1, "تم حذف جميع مجوهراتك", 1, "md") 
end
if text == 'حذف رسائلي' then
database:del('JOKER:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_)
database:del('JOKER:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
...
📚  ¦ الآوآمـر آلعآمـهہ‌‏ للمجموعهہ‌‏
 ٴ━━━━━━━━━━
📙  ¦ م1 ⊰• لعرض اوامر الحمايهہ‌‏

📘  ¦ م2 ⊰• لعرض اوامر الادمنيهہ‌‏

📗  ¦ م3 ⊰• لعرض اوامر المدراء

📕  ¦ م4 ⊰• لعرض اوامر المطورين

📓  ¦ م5 ⊰• آوآمر حمايهہ‌‏ بالتقيد
 ٴ━━━━━━━━━━
<a href="https://telegram.me/llJOKERll">📡  ¦ Welcome to Joker source</a>
]]
...
⊰• <a href="https://telegram.me/JOKERFiles">Files of Sures،" </a>

⊰• <a href="https://telegram.me/joinchat/GLOSYRCRRGXupWthHnDjXg">Team Joker،" </a>
 ٴ━━━━━━━━━━
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
   end
