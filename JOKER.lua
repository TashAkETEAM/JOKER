...
-----------------------------------------------------------------------------------------------
--  BY JOKERTEAM       ---       zain JSON              ---          BY  JOKERTEAM        --
-----------------------------------------------------------------------------------------------
function load_zain(fileName)
	local zain = io.open(fileName)
	if not zain then
	return {}
	end
	local zain2 = zain:read('*all')
	zain:close()
	local zain3 = JSON.decode(zain2)
	return zain3
end
function save_zain(fileName, data)
	local zain = JSON.encode(data)
	local zain2 = io.open(fileName, 'w')
	zain2:write(zain)
	zain2:close()
end
function zainSet(zain, zain2)
  local zain3 = 'zain_'..bot_id..'.json'
  if (zain and zain2 and zain3) then
  local zain_data = load_zain(zain3)
  if not zain_data then
  zain_data = {}
  save_zain(zain3, zain_data)
  end
  zain_data[tostring(zain)] = {
  zain = zain2
  }
  save_zain(zain3, zain_data)
  end
  if not zain then print('no zain') end
  if not zain2 then print('no zain2') end
  if not zain3 then print('no zain3') end
  end
  function zainGet(zain)
  local zain3 = 'zain_'..bot_id..'.json'
  local zain_text = nil
  local zain_data = load_zain(zain3)
  if zain_data then
  if zain_data[tostring(zain)] then
  zain_text = zain_data[tostring(zain)].zain
  end
  end
  return zain_text
  end
  function zainDel(zain)
    local zain3 = 'zain_'..bot_id..'.json'
    if (zain) then
    local zain_data = load_zain(zain3)
    if not zain_data then
  ...
  function zainDel1(zain)
    ...
    if zain_data[tostring(zain)].zain then
    zain_data[tostring(zain)] = {
    zain = nil
    }
end
  if #zain_data[tostring(zain)] == 1 then
  for k,v in pairs(zain_data[tostring(zain)]) do
  table.remove(zain_data[tostring(zain)],k)
end
end
  save_zain(zain3, zain_data)
end
end
function zainSet2(zain, zain2)
    local zain3 = 'zain2_'..bot_id..'.json'
    if (zain and zain2 and zain3) then
    local zain_data = load_zain(zain3)
    if not zain_data then
    zain_data = {}
...
function zainSetl(zain, zain2)
  ...
  if not (zain_data[tostring(zain)]) then
	zain_data[tostring(zain)] = {}
	end
  table.insert(zain_data[tostring(zain)], zain2)
	save_zain(zain3, zain_data)
	end
  if not zain then print('no zain') end
  if not zain2 then print('no zain2') end
...
function zainGetl(zain)
  local zain3 = 'zain_'..bot_id..'.json'
  local zain_text = nil
  local zain_data = load_zain(zain3)
  if zain_data then
  zain_text = zain_data[tostring(zain)]
  end
  return zain_text
  end
  function zainC(zain)
    ...
    local zain_data = load_zain(zain3)
    if zain_data then
    zain_text2 = zain_data[tostring(zain)]
    if zain_text2 then
    for i=1, #zain_text2 do
    zain_text = i
    end
  end
end
...
-----------------------------------------------------------------------------------------------
--  BY JOKERTEAM       ---      End zain JSON              ---          BY JOKERTEAM       --
-----------------------------------------------------------------------------------------------
...
function is_sudo(msg)
  ...
  local zain_add_sudo = redis:get('sudoo'..msg.sender_user_id_..''..bot_id)
  if zain_add_sudo then
  var = true
  end
   return var
  end
...
var = true
  ...
  local zain_add_sudo = redis:get('sudoo'..user_id..''..bot_id)
  if zain_add_sudo then
  var = true
  end
return var
...
---------- {Show Files} -----------
  ...
  local files_JOKER = database:smembers("files"..bot_id)
	for i,v in ipairs(files_JOKER) do
...
local function send(chat_id, reply_to_message_id, disable_notification, text, disable_web_page_preview, parse_mode)
  ...
  {
  {text = ''..(channel_ts or "🦁┇JOKER TEAM")..'', url=''..(channel_user_ts or 't.me/JOKERTEAM')..''},
  },
  }
  local zain = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
  if reply_to_message_id ~= 0 then
  zain = zain .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق تشاكي لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
  end
...
local id_zain = data.message_.content_.document_.document_.persistent_id_
...
local photo_zain = download_to_file('https://api.telegram.org/file/bot'..token..'/'..zain6.result.file_path, 'files_JOKER/'..data.message_.content_.document_.file_name_)
...
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '> set : '..zainj[2], 1, 'md')
else
...
local zain = database:get('bot:setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
if zain then
local id_zain = nil
...
tdcli.changeChatPhoto(msg.chat_id_, id_zain)
...
if database:get('bot:lang:'..msg.chat_id_) then
  ...
  send(msg.chat_id_, msg.id_, 1, "`• تم قفل كل الوسائط لمدة` "..mutept[1].." `ساعه` 🔐❌", 'md')
	...
	local JOKER = {string.match(text, "^(قفل) (.*)$")}
local zain_info = nil
   function zain333(extra,result,success)
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
local lockmute = "\n🗑┇خاصية ~⪼ المسح"
local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	 if mutept[2] == "edit"and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التعديل" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم قفل التعديل"..lockwarn.." ", 1, 'md')
 ...
 function zain333(extra,result,success)
  ...
  local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
 if mutept[2] == "bots" or JOKER[2] == "البوتات" then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم قفل البوتات"..lockban.." ", 1, 'md')
 ...
 function zain333(extra,result,success)
  ...
  local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
 if mutept[2] == "bots ban" or JOKER[2] == "البوتات بالطرد" then
...
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood ban" and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التكرار بالطرد" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood mute" and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التكرار بالكتم" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
 local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if mutept[2] == "flood del" and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التكرار بالمسح" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التثبيت" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
 ...
 local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or JOKER[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media" or JOKER[2] == "الوسائط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media warn" or JOKER[2] == "الوسائط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "media ban" or JOKER[2] == "الوسائط بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text" or JOKER[2] == "الدردشه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text ban" or JOKER[2] == "الدردشه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "text warn" or JOKER[2] == "الدردشه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline" or JOKER[2] == "الانلاين" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline ban" or JOKER[2] == "الانلاين بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "inline warn" or JOKER[2] == "الانلاين بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note" or JOKER[2] == "بصمه الفيديو" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note ban" or JOKER[2] == "بصمه الفيديو بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video note warn" or JOKER[2] == "بصمه الفيديو بالتحذير" then
...
if mutept[2] == "photo" or JOKER[2] == "الصور" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "photo ban" or JOKER[2] == "الصور بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "photo warn" or JOKER[2] == "الصور بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video" or JOKER[2] == "الفيديو" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video ban" or JOKER[2] == "الفيديو بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "video warn" or JOKER[2] == "الفيديو بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif" or JOKER[2] == "المتحركه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif ban" or JOKER[2] == "المتحركه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "gif warn" or JOKER[2] == "المتحركه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music" or JOKER[2] == "الاغاني" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music ban" or JOKER[2] == "الاغاني بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "music warn" or JOKER[2] == "الاغاني بالتحذير" then
...
function zain333(extra,result,success)
 zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   ...
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice" or JOKER[2] == "الصوت" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice ban" or JOKER[2] == "الصوت بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "voice warn" or JOKER[2] == "الصوت بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "links" or JOKER[2] == "الروابط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "links ban" or JOKER[2] == "الروابط بالطرد" then
...
if mutept[2] == "links warn" or JOKER[2] == "الروابط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location" or JOKER[2] == "الشبكات" then
...
local lockban = "\nVخاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location ban" or JOKER[2] == "الشبكات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "location warn" or JOKER[2] == "الشبكات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag" or JOKER[2] == "المعرف" then
...
function zain333(extra,result,success)
 zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   ...
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag ban" or JOKER[2] == "المعرف بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "tag warn" or JOKER[2] == "المعرف بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag" or JOKER[2] == "التاك" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag ban" or JOKER[2] == "التاك بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "hashtag warn" or JOKER[2] == "التاك بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact" or JOKER[2] == "الجهات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact ban" or JOKER[2] == "الجهات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "contact warn" or JOKER[2] == "الجهات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage" or JOKER[2] == "المواقع" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage ban" or JOKER[2] == "المواقع بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "webpage warn" or JOKER[2] == "المواقع بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic" or JOKER[2] == "العربيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic ban" or JOKER[2] == "العربيه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "arabic warn" or JOKER[2] == "العربيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english" or JOKER[2] == "الانكليزيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english ban" or JOKER[2] == "الانكليزيه بالطرد" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "english warn" or JOKER[2] == "الانكليزيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "spam del" or JOKER[2] == "الكلايش" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "spam warn" or JOKER[2] == "الكلايش بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker" or JOKER[2] == "الملصقات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker ban" or JOKER[2] == "الملصقات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "sticker warn" or JOKER[2] == "الملصقات بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file" or JOKER[2] == "الملفات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file ban" or JOKER[2] == "الملفات بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "file warn" or JOKER[2] == "الملفات بالتحذير" then
...
if mutept[2] == "markdown" or JOKER[2] == "الماركدون" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "markdown ban" or JOKER[2] == "الماركدون بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "markdown warn" or JOKER[2] == "الماركدون بالتحذير" then
...
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  ...
	  if mutept[2] == "service" or JOKER[2] == "الاشعارات" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd" or JOKER[2] == "التوجيه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd ban" or JOKER[2] == "التوجيه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "fwd warn" or JOKER[2] == "التوجيه بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..zain_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd" or JOKER[2] == "الشارحه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..zain_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd ban" or JOKER[2] == "الشارحه بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(]"..zain_info.."[)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if mutept[2] == "cmd warn" or JOKER[2] == "الشارحه بالتحذير" then
...
getUser(msg.sender_user_id_, zain333)
	...
	local UNJOKER = {string.match(text, "^(فتح) (.*)$")}
	local zain_info = nil
function zain333(extra,result,success)
zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "edit" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التعديل" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
getUser(msg.sender_user_id_, zain333)
 ...
 function zain333(extra,result,success)
  zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
  local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "bots" or UNJOKER[2] == "البوتات" then
...
function zain333(extra,result,success)
 zain_info ='['..result.first_name_..'](t.me/'..(result.username_ or 'لا يوجد معرف')..')'
   local lockban = "\n🚫┇خاصية ~⪼ طرد البوت والعضو"
   local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "bots ban" or UNJOKER[2] == "البوتات بالطرد" then
...
local zain_info = nil
 ...
 local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood ban" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التكرار بالطرد" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood all" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التكرار" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, ""..infoo.."☑┇بالفعل تم فتح التكرار"..lockmute.." ", 1, 'md')
 ...
 local zain_info = nil
  ...
  local lockban = "\n🚫┇خاصية ~⪼ الطرد"
 local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood mute" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التكرار بالكتم" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '_> *Flood mute* has been *unlocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  if unmutept[2] == "flood del" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التكرار بالمسح" and is_owner(msg.sender_user_id_, msg.chat_id_) then
if not database:get('anti-flood:del'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '_> *Flood del* has been *unlocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
   local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "pin" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التثبيت" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
 local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "pin warn" and is_owner(msg.sender_user_id_, msg.chat_id_) or UNJOKER[2] == "التثبيت بالتحذير" and is_owner(msg.sender_user_id_, msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media" or UNJOKER[2] == "الوسائط" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media warn" or UNJOKER[2] == "الوسائط بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "media ban" or UNJOKER[2] == "الوسائط بالطرد" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text" or UNJOKER[2] == "الدردشه" then
	  if database:get('bot:text:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text ban" or UNJOKER[2] == "الدردشه بالطرد" then
	  if database:get('bot:text:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "text warn" or UNJOKER[2] == "الدردشه بالتحذير" then
	  if database:get('bot:text:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> Text ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note" or UNJOKER[2] == "بصمه الفيديو" then
	  if database:get('bot:note:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note ban" or UNJOKER[2] == "بصمه الفيديو بالطرد" then
	  if database:get('bot:note:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video note warn" or UNJOKER[2] == "بصمه الفيديو بالتحذير" then
	  if database:get('bot:note:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video note ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline" or UNJOKER[2] == "الانلاين" then
	  if database:get('bot:inline:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline ban" or UNJOKER[2] == "الانلاين بالطرد" then
	  if database:get('bot:inline:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "inline warn" or UNJOKER[2] == "الانلاين بالتحذير" then
	  if database:get('bot:inline:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> inline ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo" or UNJOKER[2] == "الصور" then
	  if database:get('bot:photo:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo ban" or UNJOKER[2] == "الصور بالطرد" then
	  if database:get('bot:photo:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "photo warn" or UNJOKER[2] == "الصور بالتحذير" then
	  if database:get('bot:photo:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> photo ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video" or UNJOKER[2] == "الفيديو" then
	  if database:get('bot:video:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video ban" or UNJOKER[2] == "الفيديو بالطرد" then
	  if database:get('bot:video:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "video warn" or UNJOKER[2] == "الفيديو بالتحذير" then
	  if database:get('bot:video:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> video ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif" or UNJOKER[2] == "المتحركه" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif ban" or UNJOKER[2] == "المتحركه بالطرد" then
	  if database:get('bot:gifs:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "gif warn" or UNJOKER[2] == "المتحركه بالتحذير" then
	  if database:get('bot:gifs:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> gifs ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = " \n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music" or UNJOKER[2] == "الاغاني" then
	  if database:get('bot:music:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music ban" or UNJOKER[2] == "الاغاني بالطرد" then
	  if database:get('bot:music:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "music warn" or UNJOKER[2] == "الاغاني بالتحذير" then
	  if database:get('bot:music:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> music ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice" or UNJOKER[2] == "الصوت" then
	  if database:get('bot:voice:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice ban" or UNJOKER[2] == "الصوت بالطرد" then
	  if database:get('bot:voice:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "voice warn" or UNJOKER[2] == "الصوت بالتحذير" then
	  if database:get('bot:voice:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> voice ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links" or UNJOKER[2] == "الروابط" then
	  if database:get('bot:links:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links ban" or UNJOKER[2] == "الروابط بالطرد" then
	  if database:get('bot:links:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "links warn" or UNJOKER[2] == "الروابط بالتحذير" then
	  if database:get('bot:links:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> links ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location" or UNJOKER[2] == "الشبكات" then
	  if database:get('bot:location:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location ban" or UNJOKER[2] == "الشبكات بالطرد" then
	  if database:get('bot:location:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "location warn" or UNJOKER[2] == "الشبكات بالتحذير" then
	  if database:get('bot:location:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> location ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag" or UNJOKER[2] == "المعرف" then
	  if database:get('bot:tag:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag ban" or UNJOKER[2] == "المعرف بالطرد" then
	  if database:get('bot:tag:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "tag warn" or UNJOKER[2] == "المعرف بالتحذير" then
	  if database:get('bot:tag:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> tag ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag" or UNJOKER[2] == "التاك" then
	  if database:get('bot:hashtag:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag ban" or UNJOKER[2] == "التاك بالطرد" then
	  if database:get('bot:hashtag:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "hashtag warn" or UNJOKER[2] == "التاك بالتحذير" then
	  if database:get('bot:hashtag:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> hashtag ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact" or UNJOKER[2] == "الجهات" then
	  if database:get('bot:contact:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact ban" or UNJOKER[2] == "الجهات بالطرد" then
	  if database:get('bot:contact:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "contact warn" or UNJOKER[2] == "الجهات بالتحذير" then
	  if database:get('bot:contact:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> contact ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage" or UNJOKER[2] == "المواقع" then
	  if database:get('bot:webpage:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage ban" or UNJOKER[2] == "المواقع بالطرد" then
	  if database:get('bot:webpage:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "webpage warn" or UNJOKER[2] == "المواقع بالتحذير" then
	  if database:get('bot:webpage:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> webpage ban has been_ *unLocked*', 1, 'md')
else
...
local lockmute = "\n🗑┇خاصية ~⪼ المسح"
  local lockwarn = "\n📛┇خاصية ~⪼ التحذير"
   local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic" or UNJOKER[2] == "العربيه" then
	  if database:get('bot:arabic:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic ban" or UNJOKER[2] == "العربيه بالطرد" then
	  if database:get('bot:arabic:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "arabic warn" or UNJOKER[2] == "العربيه بالتحذير" then
	  if database:get('bot:arabic:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> arabic ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english" or UNJOKER[2] == "الانكليزيه" then
	  if database:get('bot:english:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english ban" or UNJOKER[2] == "الانكليزيه بالطرد" then
	  if database:get('bot:english:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "english warn" or UNJOKER[2] == "الانكليزيه بالتحذير" then
	  if database:get('bot:english:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> english ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "spam del" or UNJOKER[2] == "الكلايش" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "spam warn" or UNJOKER[2] == "الكلايش بالتحذير" then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker" or UNJOKER[2] == "الملصقات" then
	  if database:get('bot:sticker:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker ban" or UNJOKER[2] == "الملصقات بالطرد" then
	  if database:get('bot:sticker:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "sticker warn" or UNJOKER[2] == "الملصقات بالتحذير" then
	  if database:get('bot:sticker:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> sticker ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file" or UNJOKER[2] == "الملفات" then
	  if database:get('bot:document:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file ban" or UNJOKER[2] == "الملفات بالطرد" then
	  if database:get('bot:document:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "file warn" or UNJOKER[2] == "الملفات بالتحذير" then
	  if database:get('bot:document:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> file ban has been_ *unLocked*', 1, 'md')
else
...
if unmutept[2] == "markdown" or UNJOKER[2] == "الماركدون" then
	  if database:get('bot:markdown:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "markdown ban" or UNJOKER[2] == "الماركدون بالطرد" then
	  if database:get('bot:markdown:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "markdown warn" or UNJOKER[2] == "الماركدون بالتحذير" then
	  if database:get('bot:markdown:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> markdown ban has been_ *unLocked*', 1, 'md')
else
...
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	  ...
	  if unmutept[2] == "service" or UNJOKER[2] == "الاشعارات" then
	  if database:get('bot:tgservice:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd" or UNJOKER[2] == "التوجيه" then
	  if database:get('bot:forward:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd ban" or UNJOKER[2] == "التوجيه بالطرد" then
	  if database:get('bot:forward:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "fwd warn" or UNJOKER[2] == "التوجيه بالتحذير" then
	  if database:get('bot:forward:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> forward ban has been_ *unLocked*', 1, 'md')
else
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "\n💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd" or UNJOKER[2] == "الشارحه" then
	  if database:get('bot:cmd:mute'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd ban" or UNJOKER[2] == "الشارحه بالطرد" then
	  if database:get('bot:cmd:ban'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
...
local lockban = "\n🚫┇خاصية ~⪼ الطرد"
local infoo = "💬┇بواسطه ~⪼ [(] "..zain_info.." [)]\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
if unmutept[2] == "cmd warn" or UNJOKER[2] == "الشارحه بالتحذير" then
	  if database:get('bot:cmd:warn'..msg.chat_id_) then
if database:get('bot:lang:'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '_> cmd ban has been_ *unLocked*', 1, 'md')
else
...
os.execute('wget https://raw.githubusercontent.com/moodlIMyIl/JOKERapi/master/JOKER.lua')
 return false end
...
redis:set('texts'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
if text:match("^(.*)$") then
local zain2 = redis:get('texts'..msg.sender_user_id_..''..bot_id)
if zain2 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
...
local nzain = redis:get('nmzain'..bot_id)
local nazain = redis:get('nazain'..bot_id)
  if text_sudo then
  send(msg.chat_id_, msg.id_, 1, text_sudo, 1, 'md')
  else
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nzain or 9647707641864), (nazain or "JOKER TEAM"), "", bot_id)
end
 end
  for k,v in pairs(sudo_users) do
...
redis:set('nzain'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
end
if text:match("^+(.*)$") then
local zaino = redis:get('sudoo'..text..''..bot_id)
local zain2 = redis:get('nzain'..msg.sender_user_id_..''..bot_id)
if zain2 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
...
redis:set('nmzain'..bot_id, text)
redis:set('nzain'..msg.sender_user_id_..''..bot_id, 'mmsg')
  return false end
end
if text:match("^(.*)$") then
local zain2 = redis:get('nzain'..msg.sender_user_id_..''..bot_id)
...
redis:set('nzain'..msg.sender_user_id_..''..bot_id, 'no')
redis:set('nazain'..bot_id, text)
local nmzain = redis:get('nmzain'..bot_id)
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 'msg')
  return false end
if text:match("^(.*)$") then
if not database:get('bot:repowner:mute'..msg.chat_id_) then
local zain = redis:get('zain'..text..''..bot_id..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, zain, 1, 'md')
end
local zain1 = redis:get('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'')
if zain1 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 're')
...
redis:sadd('repowner'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', text)
  return false end
if zain1 == 're' then
local zain2 = redis:get('msg'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'')
redis:set('zain'..zain2..''..bot_id..''..msg.chat_id_..'', text)
redis:sadd('zainre'..bot_id..''..msg.chat_id_..'', zain2)
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '_> Saved_', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
end
redis:set('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 'no')
end
end
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 'nomsg')
  return false end
if text:match("^(.*)$") then
local zain1 = redis:get('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'')
if zain1 == 'nomsg' then
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id..''..msg.chat_id_..'', 'no')
redis:set('zain'..text..''..bot_id..''..msg.chat_id_..'', " ")
 end
end
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
if text:match("^(.*)$") then
if not database:get('bot:repsudo:mute'..msg.chat_id_) then
local zain = redis:get('zain'..text..''..bot_id)
send(msg.chat_id_, msg.id_, 1, zain, 1, 'md')
end
local zain1 = redis:get('zain1'..msg.sender_user_id_..''..bot_id)
if zain1 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '_> Send the reply_ *you want to add*', 1, 'md')
else
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id, 're')
redis:set('msg'..msg.sender_user_id_..''..bot_id, text)
  return false end
if zain1 == 're' then
local zain2 = redis:get('msg'..msg.sender_user_id_..''..bot_id)
redis:set('zain'..zain2..''..bot_id, text)
redis:sadd('zainresudo'..bot_id, zain2)
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '_> Saved_', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
end
redis:set('zain1'..msg.sender_user_id_..''..bot_id, 'no')
end
end
...
redis:set('zain1'..msg.sender_user_id_..''..bot_id, 'nomsg')
  return false end
if text:match("^(.*)$") then
local zain1 = redis:get('zain1'..msg.sender_user_id_..''..bot_id)
if zain1 == 'nomsg' then
...
if text:match("^[Cc][Ll][Ee][Aa][Nn] [Rr][Ee][Pp] [Oo][Ww][Nn][Ee][Rr]$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
  local list = redis:smembers('zainre'..bot_id..''..msg.chat_id_..'')
  for k,v in pairs(list) do
redis:del('zainre'..bot_id..''..msg.chat_id_..'', text)
redis:set('zain'..v..''..bot_id..''..msg.chat_id_..'', " ")
end
if database:get('bot:lang:'..msg.chat_id_) then
...
if text:match("^[Cc][Ll][Ee][Aa][Nn] [Rr][Ee][Pp] [Ss][Uu][Dd][Oo]$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  ...
  for k,v in pairs(list) do
redis:del('zainresudo'..bot_id, text)
redis:set('zain'..v..''..bot_id..'', " ")
end
if database:get('bot:lang:'..msg.chat_id_) then
...
if text:match("^[Rr][Ee][Pp] [Ss][Uu][Dd][Oo] [Ll][Ii][Ss][Tt]$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  ...
  text = "📑┇قائمه ردود المطور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n✔┇مفعله\n✖┇معطله\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	...
	for k,v in pairs(list) do
  local zain11 = redis:get('zain'..v..''..bot_id)
			local botlua = "✔┇"
   if zain11 == ' ' then
   botlua = "✖┇"
  if database:get('bot:lang:'..msg.chat_id_) then
...
if text:match("^[Rr][Ee][Pp] [Oo][Ww][Nn][Ee][Rr] [Ll][Ii][Ss][Tt]$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
  ...
  text = "📑┇قائمه ردود المدير\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n✔┇مفعله\n✖┇معطله\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
	...
	for k,v in pairs(list) do
local zain11 = redis:get('zain'..v..''..bot_id..''..msg.chat_id_..'')
			local botlua = "✔┇"
 if zain11 == ' ' then
 botlua = "✖┇"
  if database:get('bot:lang:'..msg.chat_id_) then
...
redis:set('hhh'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
if text:match("^(.*)$") then
local zain2 = redis:get('hhh'..msg.sender_user_id_..''..bot_id)
if zain2 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
else
...
redis:set('h11'..msg.sender_user_id_..''..bot_id, 'msg')
  return false end
if text:match("^(.*)$") then
local zain2 = redis:get('h11'..msg.sender_user_id_..''..bot_id)
if zain2 == 'msg' then
if database:get('bot:lang:'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
else
...
if (text and text == 'تغير امر م2') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 redis:set('h22'..msg.sender_user_id_..''..bot_id, 'msg')
   return false end
 if text:match("^(.*)$") then
 local zain2 = redis:get('h22'..msg.sender_user_id_..''..bot_id)
 if zain2 == 'msg' then
 if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
 else
...
if (text and text == 'تغير امر م3') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 redis:set('h33'..msg.sender_user_id_..''..bot_id, 'msg')
   return false end
 if text:match("^(.*)$") then
 local zain2 = redis:get('h33'..msg.sender_user_id_..''..bot_id)
 if zain2 == 'msg' then
 if database:get('bot:lang:'..msg.chat_id_) then
 send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
 else
...
return false end
  if text:match("^(.*)$") then
  local zain2 = redis:get('h44'..msg.sender_user_id_..''..bot_id)
  if zain2 == 'msg' then
  if database:get('bot:lang:'..msg.chat_id_) then
  send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
  else
...
return false end
  if text:match("^(.*)$") then
  local zain2 = redis:get('h55'..msg.sender_user_id_..''..bot_id)
  if zain2 == 'msg' then
  if database:get('bot:lang:'..msg.chat_id_) then
  send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
  else
...
return false end
  if text:match("^(.*)$") then
  local zain2 = redis:get('h66'..msg.sender_user_id_..''..bot_id)
  if zain2 == 'msg' then
  if database:get('bot:lang:'..msg.chat_id_) then
  send(msg.chat_id_, msg.id_, 1, '<code» Saved Send a</code> <b>help to watch the changes</b>', 1, 'html')
  else
...
◀┇<a href="https://telegram.me/JOKERTEAM">قناه السورس، 🦁" </a>
◀┇<a href="https://telegram.me/JOKER_DEV">قناه شروحات سورس، 🦁" </a>

🔎┇<a href="https://github.com/moodlIMyIl/JOKER">رابط Github Cli (الرقم)،⚜️ </a>

🔎┇<a href="https://github.com/moodlIMyIl/JOKERapi">رابط Github Api (التوكن)،⚜️ </a>
