...
if text == ''..(database:get(JOKER..'SMALE:GAME'..msg.chat_id_) or '')..'' and not database:get(JOKER..'SMALE:GAMES'..msg.chat_id_) then
tahadevJOKER:incrby(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
tahadevJOKER:set(JOKER..'SMALE:GAMES'..msg.chat_id_,true)
NUMPGAME = (database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊¦ مبروك فزت 🍂\n🎁¦ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭¦* للعب مره اخرى ارسل `الاسرع` \n', 1, 'md')
end 

if text == ''..(database:get(JOKER..'CHEK:CHER'..msg.chat_id_) or '')..'' and not database:get(JOKER..'RTEP:CHER'..msg.chat_id_) then
tahadevJOKER:incrby(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
tahadevJOKER:set(JOKER..'RTEP:CHER'..msg.chat_id_,true)
NUMPGAME = (database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊¦ مبروك فزت 🍂\n🎁¦ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭¦* للعب مره اخرى ارسل `معاني` \n', 1, 'md')
end 

if text == ''..(database:get(JOKER..'klmo'..msg.chat_id_) or 'لفاتع')..'' and not database:get(JOKER..'CHER:GAME'..msg.chat_id_) then
tahadevJOKER:incrby(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
tahadevJOKER:set(JOKER..'CHER:GAME'..msg.chat_id_,true)
NUMPGAME = (database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
...
if chat_type == 'super' then 
if MSG_TEXT[1] == 'الاسرع' and not database:get(JOKER.."LOCK:GAMES"..msg.chat_id_) then 
tahadevJOKER:del(JOKER..'SMALE:GAMES'..msg.chat_id_)
katu = {'🍏','🍎','843578','9755','25677','578866','14589','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚕','7643','93289','3457','95439','378865','24568','9976','289','2288','2854','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
tahadevJOKER:set(JOKER..'SMALE:GAME'..msg.chat_id_,katu[math.random(#katu)])
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'اسرع واحد يدز هذهہٓ ››  `'..database:get(JOKER..'SMALE:GAME'..msg.chat_id_)..'`', 1, 'md')
end

if MSG_TEXT[1] == 'معاني' and not database:get(JOKER.."LOCK:GAMES"..msg.chat_id_) then 
tahadevJOKER:del(JOKER..'RTEP:CHER'..msg.chat_id_)
...
name = katu[math.random(#katu)]
tahadevJOKER:set(JOKER..'CHEK:CHER'..msg.chat_id_,name)
...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'اسرع واحد يدز معنى السمايل يفوز » { '..name..' }', 1, 'md')
end

if MSG_TEXT[1] == 'ترتيب' and not database:get(JOKER.."LOCK:GAMES"..msg.chat_id_) then 
tahadevJOKER:del(JOKER..'CHER:GAME'..msg.chat_id_)
katu = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = katu[math.random(#katu)]
tahadevJOKER:set(JOKER..'klmo'..msg.chat_id_,name)
name = string.gsub(name,'سحور','س ر و ح')
name = string.gsub(name,'سياره','ه ر س ي ا')
name = string.gsub(name,'استقبال','ل ب ا ت ق س ا')
name = string.gsub(name,'قنفه','ه ق ن ف')
...
name = string.gsub(name,'ساحه','ح ا ه س')
name = string.gsub(name,'جسر','ر ج س')
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'*💥¦ اسرع واحد يرتب هاي الكلمه » {'..name..'} يفوز 🎉*\n', 1, 'md')
end

if MSG_TEXT[1] =='نقودي' then 
if tonumber((database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
JOKER_sendMsg(msg.chat_id_, msg.id_, 1, ' *💬¦ ليس لديك نقود ،\n📬¦ للحصول ؏ النقود ،\n📮¦ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
else
NUMPGAME = (database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ عدد النقود التي ربحتها هي » { '..NUMPGAME..' }\n📬¦ تسطيع بيع نقودك ولحصول على (50) رساله مقابل كل نقطه من النقود *\n', 1, 'md') 
end
end
...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,"\n*📮¦ لا استطيع البيع اقل من 1 \n*", 1, 'md') 
return false end
if tonumber(database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == 0 then
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ ليس لديك نقود من الالعاب \n📬¦ اذا كنت تريد ربح النقود \n🎮¦ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
else
local NUM_GAMES = database:get(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ ليس لديك نقود بهاذا العدد \n📬¦ لزيادة نقودك في اللعبه \n🎮¦ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
return false end
local NUMNKO = (NUMPY * 50)
tahadevJOKER:decrby(JOKER..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
tahadevJOKER:incrby(JOKER..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
...
return false  end 
if database:get(JOKER..'LOCK:GAMES'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل الالعاب في المجموعه *\n✓' 
JOKER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevJOKER:del(JOKER..'LOCK:GAMES'..msg.chat_id_) 
else
...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,"\n*📮¦ هاذا الامر خاص للمدراء فما فوق\n*", 1, 'md') 
return false  end 
if not database:get(JOKER..'LOCK:GAMES'..msg.chat_id_) then
taha = '*📮¦ تم تعطيل الالعاب في المجموعه *\n✓' 
JOKER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
tahadevJOKER:set(JOKER..'LOCK:GAMES'..msg.chat_id_,true) 
else
...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,COMGAME, 1, 'md') 
end
end
