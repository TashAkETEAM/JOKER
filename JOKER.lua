...
openChat(msg.chat_id_,JOKER_info)
database:srem("JOKER:gog"..bot_id, msg.chat_id_)
database:del('JOKER:'..bot_id.."charge:"..msg.chat_id_)
function JOKER_info2(k1,k2)
...
openChat(msg.chat_id_,JOKER_info2) 
--
end
else
...
openChat(msg.chat_id_,JOKER_info)
database:sadd("JOKER:gog"..bot_id, msg.chat_id_)
function JOKER_info2(k1,k2)
function dl_cb222(t1,t2)
...
local gps2 = database:scard("JOKER:gog"..bot_id) or 0
...
local gps2 = database:smembers("JOKER:gog"..bot_id) or 0
for i=1,#gps do
database:sadd("JOKER:gog"..bot_id, gps[i])
...
database:del("JOKER:gog"..bot_id,txt[2])
