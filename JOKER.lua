...
if text and text:match("^تغير الاشتراك$") and is_devzain(msg) then  
zainJOKERm:setex(JOKER.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي معرف القناة*\n💥'  
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text and text:match("^تغير رساله الاشتراك$") and is_devzain(msg) then  
zainJOKERm:setex(JOKER.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي النص الذي تريده*\n💥'  
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == "حذف رساله الاشتراك" and is_devzain(msg) then  
zainJOKERm:del(JOKER..'text:ch:user')
zain = "*📮¦ تم مسح رساله الاشتراك*\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
end
if text == "تفعيل الاشتراك الاجباري" and is_devzain(msg) then  
if zainJOKERm:get(JOKER..'add:ch:id') then
local addchusername = zainJOKERm:get(JOKER..'add:ch:username')
zain = "*📮¦ الاشتراك الاجباري مفعل \n📮¦ على القناة » *["..addchusername.."]\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
else
zainJOKERm:setex(JOKER.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
zain = "*📮¦ اهلا عزيزي المطور \n📮¦ ارسل معرف قناتك ليتم تفعيل الاشتراك الاجباري*\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
end
end
if text == "تعطيل الاشتراك الاجباري" and is_devzain(msg) then  
zainJOKERm:del(JOKER..'add:ch:id')
zainJOKERm:del(JOKER..'add:ch:username')
zain = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devzain(msg) then  
if zainJOKERm:get(JOKER..'add:ch:username') then
local addchusername = zainJOKERm:get(JOKER..'add:ch:username')
zain = "*📮¦ تم تفعيل الاشتراك الاجباري \n📮¦ على القناة » *["..addchusername.."]\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
else
zain = "*📮¦ لا يوجد قناة في الاشتراك الاجباري *\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,zain, 1, 'md') 
end
end
...
zain = '*💎¦ عدد مجوهراتك الحاليه  ('..(database:get('JOKER:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
zain1 = '*💎¦ مجموع مجوهراتك  ('..(database:get('JOKER:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
zain = (database:get('JOKER:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('JOKER:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('JOKER:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,zain)  
database:del('JOKER:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
zain = tonumber((database:get('JOKER:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
