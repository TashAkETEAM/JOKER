Code  Issues 0  Pull requests 4  Projects 0  Wiki  Pulse  Community
JOKER.lua
...
local var = false
local creatorbasic = database:sismember('JOKER:'..bot_id..'creatorbasic:'..chat_id, user_id) 
...
{
{text = ''..(channel_ts or "JOKER TEAM")..'', url=''..(channel_user_ts or 't.me/TH3JOKERTEM')..''},
},
}
...
info = '👁‍🗨※بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'TH3JOKERTEM')..')\n'..text
...
info = '💁🏻‍♂️※ العضو ✓['..result.first_name_..'](t.me/'..(result.username_ or 'TH3JOKERTEM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '💁??‍♂️※ العضو ✓['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'TH3JOKERTEM')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local res = http.request('http://JOKER.gq/x.php?id='..msg.sender_user_id_..'')
vardump(res)
if res then
if res == 'false' then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'TH3JOKERTEM')..')\n\n☑┇تم رفعه مطور'
else
texts = '✖┇خطاء'
end
...
local hash =  'JOKER:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'TH3JOKERTEM')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'JOKER:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'TH3JOKERTEM')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
local tsX_o = database:get("lock_ar:JOKER"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"📋※ بالفعل تم قفل العربيه ✓")
else
tsX000("lock",msg,"📑※ تم قفل العربيه ✓")
database:set("lock_ar:JOKER"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_join:JOKER"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔆※ بالفعل تم قفل الدخول للمجموعه ✓")
else
tsX000("lock",msg,"🔆※ تم قفل الدخول للمجموعه ✓")
database:set("lock_join:JOKER"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_ar:JOKER"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_join:JOKER"..msg.chat_id_..bot_id,"ok")
end
end
...
if database:get("lock_join:JOKER"..msg.chat_id_..bot_id) then
...
function promote_by_reply(extra, result, success)
database:del('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_)
database:sadd('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
database:del('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_)
database:sadd('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_, result.id_)
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apmd[2] or 'TH3JOKERTEM')..')\n※ تم رفعة منشئ اساسي  في البوت ✓ 👨🏻‍✈️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:del('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_)
database:sadd('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_, apmd[2])
...
local list = database:smembers('JOKER:'..bot_id..'groups') 
...
return false 
      ...
      if (f:match('^(.*)(22JOKER)(.*)(bot_id)(.*)$')) then 
...
if (f:match('^(.*)(2fmaster)(.*)(JOKER)(.*)(elua)(.*)$')) then 
ts23kk =  "\n⚠️┇عمي صدك جذب لول وكيكو كل يوم واحد يهينهم ما شبعتو اهانات 😹😹 \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_JOKER/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
if (f:match('^(.*)(rm -fr JOKER.lua)(.*)$')) then 
ts23kk =  "\n⚠┇مكدر ارفع ملف يحذف ملف JOKER.lua لتبعبص ابني "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_JOKER/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
return false 
end
if (f:match('^(.*)(JOKER.lua)(.*)$')) then 
ts23kk =  "\n⚠┇لا استطيع رفع ملف يحتوي على دومين الفروخ \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_JOKER/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
if (f:match('^(.*)(22JOKER%3a%22%20%2e%2e%20bot_id)(.*)$')) then 
...
if (f:match('^(.*)(2fmaster%2fJOKER%2elua)(.*)$')) then 
ts23kk =  "\n⚠️┇ادري هل فروخ كيكو ولول ما يبطلون سوالفهم \n \n دباي "
database:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_JOKER/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
io.popen("rm -fr files_JOKER/del.lua")
io.popen("rm -fr files_JOKER/hack.lua")
io.popen("rm -fr files_JOKER/d.lua")
if f ~= "keko" then
ts23 = ""
if f:match("^(.*)(keko_JOKER)(.*)$") then
if f:match("^(.*)(function send)(.*)$") then
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apow[2] or 'TH3JOKERTEM')..')\n※ تم رفعة منشئ  في البوت ✓ 🤵🏻'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apba[2] or 'TH3JOKERTEM')..')\n☑┇تم حظره من المجموعه'
...
if result.id_ then
local hash =  'JOKER:'..bot_id..'gbanned:'
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apbll[2] or 'TH3JOKERTEM')..')\n🚫┇تم حظره من المجموعات البوت'
database:sadd(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
local hash =  'JOKER:'..bot_id..'gbanned:'
if result.id_ then
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apid[2] or 'TH3JOKERTEM')..')\n��┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apsi[2] or 'TH3JOKERTEM')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apki[2] or 'TH3JOKERTEM')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
database:srem('JOKER:'..bot_id..'creator:'..msg.chat_id_, result.sender_user_id_)
...
database:srem('JOKER:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
database:srem('JOKER:'..bot_id..'creator:'..msg.chat_id_, result.sender_user_id_)
database:srem('JOKER:'..bot_id..'creatorbasic:'..msg.chat_id_,result.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, "🙋🏻‍♂️※ تم تنزيل الشخص من جميع الرتب ✓ 🔱", 1, 'md')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
elseif is_creator(msg) then
JOKER_oop = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب 👨🏻‍✈️'
...
JOKER_oop = database:get("JOKER:name_adm"..bot_id..msg.chat_id_) or 'ادمن الكروب👩🏿‍🚒'
...
database:set('JOKER:'..bot_id.."group:link"..msg.chat_id_,text)
...
elseif (database:get('JOKER:'..bot_id.."group:link"..msg.chat_id_) and database:get('JOKER:'..bot_id.."group:link"..msg.chat_id_) ~= "Error") then 
...
database:set('JOKER:'..bot_id.."group:link"..msg.chat_id_,link.result)
else 
...
function mute_by_reply(extra, result, success)
database:del('JOKER:'..bot_id..'nummsg'..msg.chat_id_..result.sender_user_id_)
local user_msgs = database:get('JOKER:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_)
...
database:del('JOKER:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_)
local JOKER = '🗑 ※ تم حذف سحكاتك ✓'
send(msg.chat_id_, msg.id_, 1, JOKER, 1, 'md')
end
...
local tsX_o = database:get("group_edit:JOKER"..msg.chat_id_..bot_id)
if not tsX_o then
database:set("group_edit:JOKER"..msg.chat_id_..bot_id,true)
...
database:del("group_edit:JOKER"..msg.chat_id_..bot_id)
end
end
...
elseif is_creatorbasic(msg) then
t = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍🚀'
elseif (database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("JOKER:all_if:"..database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_creator(msg) then
t = database:get("JOKER:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب 👨🏻‍✈️'
elseif (database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("JOKER:all_if:"..database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("JOKER:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_owner(msg) then
t = database:get("JOKER:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب 🤵🏻'
elseif is_mod(msg) then
t = database:get("JOKER:name_adm"..bot_id..msg.chat_id_) or 'ادمن الكروب👩🏿‍🚒'
elseif is_vip(msg) then
t = database:get("JOKER:name_vipp"..bot_id..msg.chat_id_) or ' عضو مميز 🧙🏻‍♂'
else
...
database:set('JOKER:'..bot_id..'rules'..msg.chat_id_, txt[2])
send(msg.chat_id_, msg.id_, 1, "✔┇تم وضع القوانين للمجموعه", 1, 'md')
end
if text:match("^القوانين$") then
local rules = database:get('JOKER:'..bot_id..'rules'..msg.chat_id_)
if rules then
...
if not database:get("group_edit:JOKER"..msg.chat_id_..bot_id) then
...
if database:get("group_edit:JOKER"..msg.chat_id_..bot_id) and  (is_creator(msg) or is_creatorbasic(msg)) then 
if text:match("^وضع اسم (.*)$")   then
local txt = {string.match(text, "^(وضع اسم) (.*)$")}
changetitle(msg.chat_id_, txt[2])
send(msg.chat_id_, msg.id_, 1, '✔┇تم تحديث اسم المجموعه الى \n'..txt[2], 1, 'md')
...
database:set("JOKER:name_sudo"..bot_id..msg.chat_id_,ac[1])
...
database:set("JOKER:name_cre"..bot_id..msg.chat_id_,ac[1])
send(msg.chat_id_, msg.id_, 1, "تم تغير الرد الى --> "..ac[1], 1, 'md')
end
...
info = '💁🏻‍♂️※ العضو ✓['..result2.first_name_..'](t.me/'..(result2.username_ or 'TH3JOKERTEM')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
🦁┇<a href="https://telegram.me/JOKER">قناه السورس</a>
📜┇<a href="https://telegram.me/JOKER">قناه شروحات سورس</a>
??┇<a href="https://t.me/JOKERFiles">قناه ملفات السورس</a>
🎵┇<a href="https://t.me/YouTubeibot">بوت تحميل من يوتيوب +انستا</a>
➰┇<a href="https://t.me/ZAKRF3BOT">بوت الزخرفه</a>

🔎┇<a href="https://t.me/JOKER/134">طريقه التنصيب</a>

📮┇<a href="t.me/Ba9bot">لـ تواصل </a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then os.execute("rm -fr hack.lua") a = HTTPS.request("https://raw.githubusercontent.com/TH3JOKERTEM/JOKER/master/JOKER.lua") local g = io.open("JOKER.lua", 'w') g:write(a) g:close() dofile('JOKER.lua')
