...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647807463210), (nakeko or "JOKERTEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
local JOKER_new_text = JOKER_new_text:gsub('#photos',(all_photo_JOKERor 'لا يوجد'))
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
<a href="https://telegram.me/llJOKERll">📡┇Welcome to JOKERsource</a>
]]
...
if z_JOKERand z_JOKER== "stop" then 
if database:get("lock_lllll:JOKER"..msg.chat_id_..bot_id) then
local hash = 'flood:max:'..bot_id..msg.chat_id_
if not database:get(hash) then
floodMax = 10
