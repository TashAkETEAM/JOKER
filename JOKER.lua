...
tahadevJOKERm:setex(DEVJOKER.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
...
tahadevJOKERm:setex(DEVJOKER.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  
local t = '*📮¦ حسنآ ارسل لي النص الذي تريده*\n💥'  
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
end
if text == "حذف رساله الاشتراك" and is_devtaha(msg) then  
tahadevJOKERm:del(DEVJOKER..'text:ch:user')
taha = "*📮¦ تم مسح رساله الاشتراك*\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "تفعيل الاشتراك الاجباري" and is_devtaha(msg) then  
if tahadevJOKERm:get(DEVJOKER..'add:ch:id') then
local addchusername = tahadevJOKERm:get(DEVJOKER..'add:ch:username')
...
tahadevJOKERm:del(DEVJOKER..'add:ch:id')
tahadevJOKERm:del(DEVJOKER..'add:ch:username')
taha = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
JOKERm_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devtaha(msg) then  
if tahadevJOKERm:get(DEVJOKER..'add:ch:username') then
local addchusername = tahadevJOKERm:get(DEVJOKER..'add:ch:username')
