...
function thsake_info(k1,k2)
send(msg.chat_id_, msg.id_, 1, info.."📛¦ لقد قمت بتعطيل الـمـجـمـوعـه 😕\n🚸¦ لاعادة تشغيل المجموعه ارسل تفعيل \n✓", 1, 'md')
end
openChat(msg.chat_id_,thsake_info)
...
function thsake_info(k1,k2)
send(msg.chat_id_, msg.id_, 1, info.."📮¦ لقد قمت بتفعيل الـمـجـمـوعـه  🙋‍♂️\n📚¦ ارسل الاوامر لعرض اوامر المجموعه\n✓", 1, 'md')
end
openChat(msg.chat_id_,thsake_info)
...
send(msg.chat_id_, msg.id_, 1, "📮  ¦ المجموعه قليله لا يم
