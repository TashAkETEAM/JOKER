...
for JOKER _one in string.gmatch(result.first_name_, "[^%s]+") do
result.first_name_ = JOKER _one
break
end
end
end 
info = '💬┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'JOKER team')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(msg.sender_user_id_, keko333)
end
if value == "prore" then
function get_JOKER X(JOKER x1,JOKER x2,JOKER x3)
local id_JOKER x = JOKER x2.sender_user_id_
function keko333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'JOKER team')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(id_JOKER x, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_JOKER X)
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'JOKER team')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local res = http.request('http://94.177.198.143/x.php?id='..msg.sender_user_id_..'')
if res then
if res ~= "true" then
