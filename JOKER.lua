...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ هاذا الامر خاص بالمطور الاساسي *\n', 1, 'md') 
return false
end
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3JOKERTEM/TH3JOKERTEM/master/getfile.json")
if res == 200 then
...
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,TextS..TextE, 1, 'md') 
end
else
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,"📮¦ لا يوجد اتصال من ال api \n", 1, 'md') 
end
return false
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/TH3JOKERTEM/TH3JOKERTEM/master/plugins_/"..file)
if res == 200 then
os.execute("rm -fr plugins_/"..file)
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
load_plugins()
dofile('JOKER.lua')  
else
JOKER_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦ عذرا لا يوجد هاكذا ملف في المتجر *\n", 1, 'md') 
end
return false
end
...
dofile('JOKER.lua')  
load_plugins()
JOKER_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ تم تحديث الملفات ♻* \n', 1, 'md') 
end 
