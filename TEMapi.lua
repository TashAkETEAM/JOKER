...
os.execute('wget https://raw.githubusercontent.com/moodlIMyIl/TEMapi/master/TSHAKE.lua')
 return false end
...
local keko222 = 'https://tshake.tk/TEMapi/ch.php?id='..msg.sender_user_id_..''
...
🔎┇<a href="https://github.com/moodlIMyIl/TEMapi">رابط Github Api (التوكن)،⚜️ </a>
