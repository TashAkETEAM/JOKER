...
os.execute('cd libs && wget https://raw.githubusercontent.com/JOKERTEAM/JOKER/master/libs/utils.lua')
os.execute('rm -rf JOKER.lua')
os.execute('wget https://raw.githubusercontent.com/JOKERTEAM/JOKER/master/JOKER.lua')
os.exit()
return false
end
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nzain or 9647723177600), (nazain or "JOKER TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
??┇<a href="https://t.me/JOKERTEAM">قناه ملفات السورس</a>
...
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then os.execute("rm -fr hack.lua") a = HTTPS.request("https://raw.githubusercontent.com/JOKERTEAM/JOKER/master/JOKER.lua") local g = io.open("JOKER.lua", 'w') g:write(a) g:close() dofile('JOKER.lua')
