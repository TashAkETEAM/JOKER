...
if redis:get(JOKER..":msg_id"..msg.to.id) then
if msg.reply_id then  msgx_id = msg.reply_id  else msgx_id = false end else msgx_id = msg.id_  end
if msgx_id then
if redis:hget(JOKER..'replay:all',r) then return sendMsg(msg.to.id,msgx_id,"["..redis:hget(JOKER..'replay:all',r).."]",'md')
elseif redis:hget(JOKER..'replay_photo:group:',r) then return sendPhoto(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_photo:group:',r))  
elseif redis:hget(JOKER..'replay_voice:group:',r) then return sendVoice(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_voice:group:',r))
elseif redis:hget(JOKER..'replay_animation:group:',r) then return sendAnimation(msg.to.id,msgx_id,0,1, nil,redis:hget(JOKER..'replay_animation:group:',r))  
elseif redis:hget(JOKER..'replay_audio:group:',r) then return sendAudio(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_audio:group:',r))  
elseif redis:hget(JOKER..'replay_sticker:group:',r) then return sendSticker(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_sticker:group:',r))  
elseif redis:hget(JOKER..'replay_video:group:',r) then return sendVideo(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_video:group:',r))
--==============================
elseif redis:hget(JOKER..'replay_photo:group:'..msg.to.id,r) then return sendPhoto(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_photo:group:'..msg.to.id, r))  
elseif redis:hget(JOKER..'replay_voice:group:'..msg.to.id,r) then return sendVoice(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_voice:group:'..msg.to.id, r))
elseif redis:hget(JOKER..'replay_animation:group:'..msg.to.id,r) then return sendAnimation(msg.to.id,msgx_id,0,1, nil,redis:hget(JOKER..'replay_animation:group:'..msg.to.id, r))  
elseif redis:hget(JOKER..'replay_audio:group:'..msg.to.id,r) then return sendAudio(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_audio:group:'..msg.to.id, r))  
elseif redis:hget(JOKER..'replay_sticker:group:'..msg.to.id,r) then return sendSticker(msg.to.id,msgx_id,0,1,nil,redis:hget(JOKER..'replay_sticker:group:'..msg.to.id, r))  
elseif redis:hget(JOKER..'replay_video:group:'..msg.to.id,r) then return sendVideo(msg.to.id,msgx_id,0,1,nil, redis:hget(JOKER..'replay_video:group:'..msg.to.id, r))
elseif redis:hget(JOKER..'replay:'..msg.to.id,r) then return sendMsg(msg.to.id,msgx_id,"["..redis:hget(JOKER..'replay:'..msg.to.id, r).."]",'md') 
end else
if redis:hget(JOKER..'replay:all',r) or redis:hget(JOKER..'replay_photo:group:'..msg.to.id,r) or redis:hget(JOKER..'replay_voice:group:'..msg.to.id,r) or redis:hget(JOKER..'replay_animation:group:'..msg.to.id,r) or redis:hget(JOKER..'replay_audio:group:'..msg.to.id,r) or  redis:hget(JOKER..'replay_sticker:group:'..msg.to.id,r) or redis:hget(JOKER..'replay_video:group:'..msg.to.id,r) or redis:hget(JOKER..'replay:'..msg.to.id,r) then
